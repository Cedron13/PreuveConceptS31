...
public static void main(String[]args){
    ...
    Place a1 = new Place("a1");
    Place a2 = new Place("a2");
    Place a3 = new Place("a3");
    Place a4 = new Place("a4");
    Place a5 = new Place("a5");
    Place a6 = new Place("a6");
    Place a7 = new Place("a7");

    Place a8 = new Place("a8");
    Place a9 = new Place("a9");
    Place a10 = new Place("a10");
    Place a11 = new Place("a11");
    Place a12 = new Place("a12");
    Place a13 = new Place("a13");
